...
partial struct ZombieSpawnerSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach ((RefRW<LocalTransform> localTransform,RefRW<ZombieSpawner> zombieSpawner) in 
            SystemAPI.Query<RefRW<LocalTransform>,RefRW<ZombieSpawner>>())
        {
            ...
            entityCommandBuffer.SetComponent(zombieEntity,new RandomWalking
            {
