        ...
        public override void Bake(AnimationDataHolderAuthoring authoring)
        {
            ...
            foreach(AnimationDataSO.AnimationType animationType in System.Enum.GetValues(typeof(AnimationDataSO.AnimationType)))
            {
                ...
                BlobBuilderArray<BatchMeshID> blobBuilderArray =
                   blobBuilder.Allocate<BatchMeshID>(ref animationDataBlobBuilderArray[index].batchMeshIdArray, animationDataSO.meshArray.Length);
            ...
            //{
            //    BlobBuilderArray<BatchMeshID> blobBuilderArray =
            //       blobBuilder.Allocate<BatchMeshID>(ref animationDataBlobBuilderArray[1].batchMeshIdArray, authoring.soldierWalk.meshArray.Length);
            ...
            animationDataHolder.animationDataBlobArrayBlobAsset = blobBuilder.CreateBlobAssetReference<BlobArray<AnimationData>>(Allocator.Persistent);

            blobBuilder.Dispose();

            AddBlobAsset(ref animationDataHolder.animationDataBlobArrayBlobAsset,out Unity.Entities.Hash128 objectHash);
...
{
    public BlobAssetReference<BlobArray<AnimationData>> animationDataBlobArrayBlobAsset;
}
